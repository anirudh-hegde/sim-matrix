...
const Header = () => {
    return (
        ...
        <header class='border-solid border-[0.01em] border-gray-600 flex shadow-md py-4 px-4 sm:px-10 bg-gray-950 font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
            <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
                <a href="javascript:void(0)"><img src="./src/assets/sim-matrix.png" alt="logo" class='w-36' />
                </a>
                <div id="collapseMenu"
                ...
                <div class='flex max-lg:ml-auto space-x-4'>
                    <button
                        ...
                        class='px-4 py-2 text-sm rounded-tr-lg rounded-bl-lg font-bold text-white border-2 border-[#007bff] bg-[#007bff] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff]'>
                        Get started
                    </button>
